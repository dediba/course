let mymap = L.map('lmap').setView([32.7859, 34.9614], 18); //coordinates of elbit
...
function mapmousemove(e: L.MouseEvent) {
    ...
    h[0].innerHTML = 'The coordinates are: lat:' + Math.round(e.latlng.lat * 10000) / 10000 + "  / lng: " + Math.round(e.latlng.lng * 10000) / 10000;
